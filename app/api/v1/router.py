...
from app.api.v1.endpoints import quote, product, upload, dashboard, rule, nlp_rules, item_feedback, chat, url_scan
...
# Include URL scan endpoints
api_router.include_router(url_scan.router, tags=["url-scan"])